...
import { View, Text, Image, SafeAreaView, TouchableOpacity, FlatList, Modal, Pressable } from 'react-native';
        ...
        renderItem={({ item }) => {
          ...
          const PlaceholderImage = () => (
            <View style={styles.imagePlaceholder}>
              <Image style={styles.image}source={require('../pictures/arkkitehtuuri_placeholder.png')}></Image>
            </View>
          );

          const PlaceholderImageDetails = () => (
            <View style={styles.imagePlaceholder}>
              <Image style={styles.imageDetails}source={require('../pictures/arkkitehtuuri_placeholder.png')}></Image>
            </View>
          );
